...
export async function getServerSideProps({ params }: ParamsProps) {
  ...
  const { data: pages } = await directus.items(`${prefix}pages`).readByQuery({
    fields: [
      ...
      `blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.id`,
      `blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.type`,
      `blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.label`,
      `blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.page.slug`,
      `blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.url`,
      `blocks.item.links.${prefix}links_id.id`,
      `blocks.item.links.${prefix}links_id.type`,
      `blocks.item.links.${prefix}links_id.label`,
      `blocks.item.links.${prefix}links_id.page.slug`,
      `blocks.item.links.${prefix}links_id.url`,
