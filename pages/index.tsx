...
export async function getStaticProps() {
  ...
  const { data } = await directus.items(`${prefix}settings`).readByQuery({
    fields: [
      ...
      `root.blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.id`,
      `root.blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.type`,
      `root.blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.label`,
      `root.blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.page.slug`,
      `root.blocks.item.elements.${prefix}elements_id.links.${prefix}links_id.url`,
      `root.blocks.item.links.${prefix}links_id.id`,
      `root.blocks.item.links.${prefix}links_id.type`,
      `root.blocks.item.links.${prefix}links_id.label`,
      `root.blocks.item.links.${prefix}links_id.page.slug`,
      `root.blocks.item.links.${prefix}links_id.url`,
